      ...
      <div className="container">
        <div className="bg_grey-2 radius-10 flat-wrap-iconbox">
          <div className="flat-title lg">
            <span className="title fw-5">Keyfiyyət bizim prioritetimizdir</span>
            <div>
              <p className="sub-title text_black-2">
                Bizim istedadlı stilistlərimiz mövsümə uyğun mükəmməl geyimlər hazırlayıblar.

                Onlar növbəti dəb istiqamətində görünüşünüzü ilhamlandıracaq müxtəlif yollar təqdim edirlər.
              </p>
