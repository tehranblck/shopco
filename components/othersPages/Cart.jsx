      ...
      <div className="container">
        ...
        <div className="tf-cart-countdown">
          <div className="title-left">
            ...
            <p>Bu Məhsullar limitlidir. Ödənişi tamamlayın</p>
          </div>
          <div
          ...
          <div className="tf-page-cart-item">
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              {!cartProducts.length && (
                <>
                  <div className="row align-items-center mb-5">
                    <div className="col-6 fs-18">Səbətiniz boşdur</div>
                    <div className="col-6">
                      <Link
                        href={`/shop-default`}
              ...
              <div className="tf-page-cart-note">
                <label htmlFor="cart-note">Sifarişinizə qeyd əlavə et</label>
                <textarea
                  name="note"
                  id="cart-note"
            ...
            <div className="tf-cart-footer-inner">
              <div className="tf-free-shipping-bar">
                ...
                <div className="tf-progress-msg">
                  Alışveriş et <span className="price fw-6">₼75.00</span> daha{" "}
                  <span className="fw-6">Pulsuz çatdırılma</span>
                </div>
              </div>
              <div className="tf-page-cart-checkout">
                <div className="shipping-calculator">
                  ...
                  >
                    <h3 className="shipping-calculator-title">
                      Çatdırılma qiymətini təxmin et
                    </h3>
                  ...
                  <div className="collapse" id="shipping">
                    <div className="accordion-shipping-content">
                      <fieldset className="field">
                        <label className="label">Ölkə</label>
                        <select
                      ...
                      <fieldset className="field">
                        <label className="label">Poçt kodu</label>
                ...
                <div className="cart-checkbox">
                  ...
                  <label htmlFor="cart-gift-checkbox" className="fw-4">
                    <span>Hədiyyə qablaşdırması istəyirsiniz?</span> Only
                ...
                <p className="tf-cart-tax">
                  Vergilər və
                  <Link href={`/shipping-delivery`}>çatdırılma</Link> ödəniş zamanı hesablanacaq
                </p>
                <div className="cart-checkbox">
                  <input
                    type="checkbox"
                  ...
                  <label htmlFor="check-agree" className="fw-4">
                    Mən
                    <Link href={`/terms-conditions`}>Şərtləri </Link> qəbul edirəm
                  </label>
                </div>
                ...
                <div className="tf-page-cart_imgtrust">
                  <p className="text-center fw-6">Təhlükəsiz ödəniş</p>
