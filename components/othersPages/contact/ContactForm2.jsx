    ...
    <section className="bg_grey-7 flat-spacing-9">
      <div className="container">
        <div className="flat-title">
          <span className="title">Bizimlə Əlaqə</span>
          <p className="sub-title text_black-2">
            Əgər gözəl məhsullar istehsal edirsinizsə və ya bizimlə işləmək
            istəyirsinizsə, o zaman bizə yazın.
          </p>
        </div>
        <div>
          <form
            ...
            <div className="send-wrap">
              <div className={`tfSubscribeMsg ${showMessage ? "active" : ""}`}>
                {success ? (
                  ...
                  <p style={{ color: "red" }}>Bir problem baş verdi</p>
                )}
              </div>
              <button
                type="submit"
